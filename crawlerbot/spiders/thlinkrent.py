...
class thlinkrentSpider(scrapy.Spider):
    name = 'thlinkrentspider'
    output_name = 'thlinkrent'
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    APPEND_URL_1 = '&Type=Home&FormType=Rent&Country=%A1%C3%D8%A7%E0%B7%BE%C1%CB%D2%B9%A4%C3&Submit=Search'
    APPEND_URL_2 = '&Type=Condominiem&FormType=Rent&Country=%A1%C3%D8%A7%E0%B7%BE%C1%CB%D2%B9%A4%C3&Submit=Search'
